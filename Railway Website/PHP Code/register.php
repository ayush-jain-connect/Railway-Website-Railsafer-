...
<form class="form-group" action="connection1.php" method="post" onsubmit="validate()">
    ...
    <div class="form-group row">
         ...
         <div class="form-group row">
           ...
           <div class="col-md-3">
             <input type="text" class="form-control" id="i3" name="FirstName" placeholder="First Name">
           </div>
           ...
           <div class="col-md-3">
             <input type="text" class="form-control"  id="i4" name="LastName" placeholder="Last Name">
           </div>
          </div>
            ...
            <label for="inputGender3" class="col-sm-3 col-form-label"><h6>Gender:</h6></label> 
              <div class="col-md-3">
                 <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="i5" name="Gender" value="m">
               ...
               <div class="col-md-3">
                 <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="i5" name="Gender" value="f">
                ...
                <div class="col-md-3">
                 <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="i5" name="Gender" value="t">
          ...
          <div class="form-group row">
              ...
              <div class="col-md-3">
                 <input type="email" class="form-control" placeholder="Email" id="i7" name="Email">
              </div>
          </div>
