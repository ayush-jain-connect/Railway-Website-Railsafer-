	...
	<section class="b border border-primary" style="margin: 0% 0% 3% 0%; padding: 1% 0% 2% 0%;">
	    ...
	    <form action="search.php" method="post">
         ...
         <div class="form-group row">
           ...
           <div class="col-md-3">
             <input type="text" class="form-control" id="Station1" name="StationName" placeholder="From" autocomplete="off">
             <div id="StationList1"></div>
           </div>
           
           <label for="inputCity3" class="col-sm-3 col-form-label">To City:</label>
           <div class="col-md-3">
            <input type="text" class="form-control" id="Station2" name="StationName" placeholder="To" autocomplete="off">
            <div id="StationList2"></div>
           </div>
         </div>
         ...
         <div class="form-group row">
           ...
           <div class="col-md-3">
             <select id="inputInfant" class="form-control">
...
<footer>
    <div class="jumbotron bg-dark text-center" style="margin-bottom:0; border-radius: 0px;">
     ...
     <div class="container text-white">
         ...
         <p>
         Copyright © RailSafer. All Rights Reserved | Contact Us: +91 9XXXX XXXXX
         </p>
     </div>
    </div>
</footer>
